...
export function Hero() {
  ...
  const focusList = t.raw("focus_list") as string[];
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 pt-36 pb-20 px-6">
      ...
      <div className="flex-1 space-y-8">
        ...
        <div className="space-y-2">
          <h2 className="text-xl text-gray-400 font-mono">{t("greeting")}</h2>
        ...
        <div className="flex gap-4 pt-4">
          ...
          <a href={`mailto:${tContact("email")}`} className="p-3 bg-surface border border-white/10 rounded-lg hover:border-primary hover:text-primary hover:shadow-[0_0_15px_rgba(0,220,130,0.2)] transition-all hover:-translate-y-1">
            <Mail size={20} />
          </a>
        </div>
      </div>
