...
const PROJECTS: ProjectDef[] = [
  ...
  },
  {
    ...
    i18n: {
      pt: {
        ...
        fullDesc: "Sistema de controle automático de nível de líquido em reservatório industrial, implementado em CLP Siemens S7-1200. A arquitetura integra o TIA Portal para a programação em Ladder, o S7-PLCSIM para emulação do controlador e o Factory I/O como planta 3D, que fornece a física do processo. Os sinais analógicos são convertidos de 0–10 V para unidades de engenharia de 0 a 100% pelos blocos NORM_X e SCALE_X. O controle é On-Off com histerese: abaixo de 20% a válvula de carga abre, acima de 80% ela fecha, e a banda morta entre os limites evita o chaveamento intermitente dos atuadores.",
        status: "Concluído",
      },
      en: {
        ...
        fullDesc: "Automatic liquid level control system for an industrial tank, implemented on a Siemens S7-1200 PLC. The architecture integrates TIA Portal for Ladder programming, S7-PLCSIM for controller emulation, and Factory I/O as the 3D plant providing process physics. Analog signals are converted from 0–10 V into 0–100% engineering units through the NORM_X and SCALE_X blocks. Control is On-Off with hysteresis: below 20% the inlet valve opens, above 80% it closes, and the dead band between the limits prevents actuator chattering.",
        status: "Completed",
      },
    },
  },
  {
    ...
    categories: ["Data Science / AI", "Web"],
    icon: Brain,
  ...
  },
  {
    ...
    i18n: {
      pt: {
        ...
        fullDesc: "Estudo ecológico de série temporal sobre os 9.609.650 acompanhamentos de crianças e adolescentes registrados pelo SISVAN nos 217 municípios do Maranhão entre 2014 e 2023. A média estadual de 20,2% esconde o essencial: os adolescentes puxaram toda a alta (+0,64 p.p./ano) e inverteram de posição, saindo do grupo menos afetado em 2014 para o mais afetado em 2023, com 22,6%. O Índice de Moran (0,27) confirma dependência espacial e o LISA identifica 25 municípios Alto-Alto em territórios contíguos. O achado técnico mais relevante foi de ingestão: os rótulos dos microdados estão deslocados em uma faixa etária, e a leitura intuitiva colocaria os adolescentes em 7,0% em vez de 22,6%. Submetido ao II EANAPS 2026.",
        status: "Concluído",
      },
      en: {
        ...
        fullDesc: "Time-series ecological study covering all 9,609,650 child and adolescent records collected by SISVAN across Maranhão's 217 municipalities between 2014 and 2023. The 20.2% statewide average hides what matters: adolescents drove the entire increase (+0.64 pp/year) and flipped position, going from the least affected group in 2014 to the most affected in 2023, at 22.6%. Moran's I of 0.27 confirms spatial dependence and LISA identifies 25 High-High municipalities in contiguous territories. The most consequential technical finding was in ingestion: the microdata labels are shifted by one age band, and the intuitive reading would place adolescents at 7.0% instead of 22.6%. Submitted to II EANAPS 2026.",
        status: "Completed",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        ...
        fullDesc: "Metade prospectiva do estudo: usa a mesma década de registros do SISVAN para projetar a prevalência de excesso de peso até 2026 em 30 séries — o estado, as 3 macrorregiões e cada uma das 18 regiões de saúde. O estado sai de 20,2% para 21,4%, mas o número que importa ao gestor é outro: 11 das 18 regiões estão em alta e 6 em queda, de modo que a média estadual esconde as duas direções ao mesmo tempo. Chapadinha concentra o risco, com a maior prevalência projetada e o maior crescimento. Cada série disputou uma competição de quatro vias entre ARIMA e Prophet, decidida só pelo erro fora da amostra. Submetido ao II EANAPS 2026.",
        status: "Concluído",
      },
      en: {
        ...
        fullDesc: "The prospective half of the study: it uses the same decade of SISVAN records to forecast excess weight prevalence through 2026 across 30 series — the state, its 3 macro-regions and each of the 18 health regions. The state moves from 20.2% to 21.4%, but the number that matters to a health manager is a different one: 11 of the 18 regions are rising and 6 are falling, so the statewide average hides both directions at once. Chapadinha concentrates the risk, with the highest projected prevalence and the largest increase. Every series ran a four-way ARIMA versus Prophet competition decided purely on out-of-sample error. Submitted to II EANAPS 2026.",
        status: "Completed",
      },
    },
  },
  ...
  },
  {
    ...
    i18n: {
      pt: {
        ...
        fullDesc: "Pesquisa de mestrado sobre manutenção de diversidade populacional em Algoritmos Genéticos. A estratégia aplica clusterização periódica sobre a população, toma o melhor indivíduo de cada cluster e substitui os piores, forçando representantes de regiões distintas do espaço de busca a sobreviverem. Três variantes — K-Means, hierárquica e DBSCAN — foram comparadas ao AG padrão em 30 execuções por combinação. Na função multimodal Schwefel a clusterização reduz o fitness médio em 43%, com ANOVA significativa, embora os três métodos sejam estatisticamente indistinguíveis entre si. O trabalho evolui para um híbrido BAT-PSO e para tratamento de restrições por penalidade dinâmica.",
        status: "Concluído",
      },
      en: {
        ...
        fullDesc: "Master's research on maintaining population diversity in Genetic Algorithms. The strategy periodically clusters the population, takes the fittest individual from each cluster and replaces the worst ones, forcing representatives of distinct search-space regions to survive. Three variants — K-Means, hierarchical and DBSCAN — were compared against a standard GA across 30 runs per combination. On the multimodal Schwefel function, clustering cuts mean fitness by 43% with a significant ANOVA, though the three methods are statistically indistinguishable from each other. The work then evolves into a BAT-PSO hybrid and into constraint handling via dynamic penalty.",
        status: "Completed",
      },
    },
  },
